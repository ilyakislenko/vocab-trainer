...
const dict: Translations = {
  ...
  "quiz.type.word_order": { en: "Arrange the words", ru: "Собери предложение" },
  "quiz.type.listening": { en: "Listen and answer", ru: "Прослушай и ответь" },
  "quiz.wordOrderHint": {
    en: "Tap the words in the correct order to build the sentence.",
    ru: "Нажимай на слова в правильном порядке, чтобы собрать предложение.",
  },
  "quiz.listeningPlay": { en: "Play audio", ru: "Воспроизвести аудио" },
  "quiz.listeningType": { en: "Type what you hear", ru: "Напиши, что услышал(а)" },
